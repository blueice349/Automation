...
function NumberDecimalWidget(formObj, instance, fieldViewWrapper){"use strict";
...
NumberDecimalWidget.prototype.getFieldView = function(){"use strict";
    ...
    if(this.instance.settings.cardinality == -1){
        ...
        addButton.addEventListener('click', function(e){
            try{
                ...
                Utils.sendErrorReport("Exception in decimal add another: " + ex);
            }
        });
...
NumberDecimalWidget.prototype.redraw = function(){"use strict";
...
NumberDecimalWidget.prototype.getNewElement = function(index){"use strict";
    ...
    element.setKeyboardType(Ti.UI.KEYBOARD_DEFAULT);
...
NumberDecimalWidget.prototype.cleanUp = function(){"use strict";
    var i, j;
    Ti.API.debug("in decimal widget cleanup");
    ...
    try{
        ...
        Ti.API.debug("At end of decimal widget cleanup");
    }
    catch(ex){
        try{
            Utils.sendErrorReport("Exception cleaning up decimal widget field: " + ex);
        }
        catch(ex1){}
    }
};
...
exports.getFieldObject = function(FormObj, instance, fieldViewWrapper){"use strict";
    return new NumberDecimalWidget(FormObj, instance, fieldViewWrapper);
};
