...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.omadi.ios_gps.js')
	...
	f = os.path.join(cwd,'Classes','ComOmadiIos_gpsModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.omadi.ios_gps.js']
