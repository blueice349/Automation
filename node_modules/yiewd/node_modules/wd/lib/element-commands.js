...
/**
 * element.performTouch(touchGestures) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/perform
 */
elementCommands.performTouch = function (touchAction, cb) {
  commands.performTouch.apply(this.browser, [this, touchAction, cb]);
};
/**
 * element.performTouchAction(touchGestures) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/perform
 */
elementCommands.performTouchAction = elementCommands.performTouch;

/**
 * element.performMultiTouch(actions) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/multi/perform
 */
elementCommands.performMultiTouch = function (actions, cb) {
  commands.performMultiTouch.apply(this.browser, [this, actions, cb]);
};
/**
 * element.performMultiTouchAction(actions) -> cb(err, touchStateObjects)
 *
 * @jsonWire POST /session/:sessionId/touch/multi/perform
 */
elementCommands.performMultiTouchAction = elementCommands.performMultiTouch;
