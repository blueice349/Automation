...
module.exports.logins = function ( login ) {
	...
	switch ( login ) {
		case 'admin1' :
			return require( './common/LogIn/loginAdminTest1.js' );
		case 'admin2' :
			return require( './common/LogIn/loginAdminTest2.js' );
		case 'client1':
			return require( './common/LogIn/loginClientTest1.js' );
		case 'client2':
			return require( './common/LogIn/loginClientTest2.js' );
		case 'driver1':
			return require( './common/LogIn/loginDriverTest1.js' );
		case 'driver2':
			return require( './common/LogIn/loginDriverTest2.js' );
		case 'badLogin'    :
