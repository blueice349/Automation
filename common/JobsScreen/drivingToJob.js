			...
			if ( lastUser.userRole != 'client' 
				...
				.then( function ( openJobs ) {
					...
					if ( openJobs ) {
						...
						.click()
						.sleep ( 800 )
						.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.driving ) )
						.then( function ( driving ) {
							...
							if ( driving ) {
								...
								return driver
								.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.drivingPlus ) )
