...
describe( 'Start Arrived at Destination Process'.green, function () {

	it( 'Should updateStatus to arrived at destination from the jobs screen.'.green, function ( done ) {
			...
			if ( lastUser.userRole != 'client' && lastUser.userRole != 'AdminClient' ) {
				...
				.then( function ( openJobs ) {
					...
					if ( openJobs ) {
						...
						.click()
						.sleep ( 800 )
						.elementByNameIfExists( elements.jobsScreen.updateStatusOptions.arrivedDest )
						//.isDisplayed()
						.then( function ( arrivedDest ) {

							if ( arrivedDest ) {
								console.log( 'Arrived at Destination'.red );
								return arrivedDest
								.click();

							} else {
								return driver
								.elementByNameIfExists( elements.jobsScreen.updateStatusOptions.arrivedDestPlus )
								//.isDisplayed()
								.then( function ( arrivedDestPlus ) {
									...
									if ( arrivedDestPlus ) {
										console.log( 'Arrived at Destination +'.red );
										return driver
										.elementByName( elements.jobsScreen.updateStatusOptions.arrivedDestPlus )
										.click()
										.sleep ( 1000 )
										...
										console.log( 'No Arrived at Destination Status'.red );
										return driver
		...
		.then( function() {
			...
			console.log( 'updateStatus To Arrived at Destination has Completed....'.green );
