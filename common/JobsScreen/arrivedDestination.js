...
module.exports = function () {
	...
	describe( 'Start updateStatus to Arrived at Destination using "arrivedDestination.js"'.green, function () {
			...
			if ( lastUser.userRole != 'client' 
				...
				.then( function ( openJobs ) {
					...
					if ( openJobs ) {
						...
						.click()
						.sleep ( 800 )
						.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.arrivedDest ) )
						.then( function ( arrivedDest ) {

							if ( arrivedDest ) {
								console.log( ' Updated Statuse to "Arrived at Destination".'.red );
								return arrivedDest
								.click();

							} else {
								return driver
								.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.arrivedDestPlus ) )
								.then( function ( arrivedDestPlus ) {

									if ( arrivedDestPlus ) {
										console.log( 'Updated Status to "Arrived at Destination +"'.red );
										return arrivedDestPlus
										.click()
										.sleep ( 1000 )
										.then( function () {
										...
										.then( function ( textFieldCond ) {
											...
											if ( textFieldCond === '' ) {
												...
												console.log( 'textFieldCond has the following data: ' + driver.elementById( elements.mobile_MikeRecord.otherFields.textFieldCond ) );
											}
										} )
										...
										.then( function ( textFieldReq ) {
											...
											if ( textFieldReq === '' ) {
												...
												console.log( 'textFieldReq has the following data: ' + driver.elementById( elements.mobile_MikeRecord.otherFields.textFieldReq ) );
											}
										} )
										...
										.then( function ( updateFormInfo ) {
											...
											if( updateFormInfo ) {
												...
												console.log( 'Current Job does not need to updated to "Arrived at Destination" Status'.red );
												return driver
