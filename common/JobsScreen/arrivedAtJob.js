...
module.exports = function () {
	...
	describe( 'Start updateStatus to Arrived at Scene using "arrivedAtJob.js"'.green, function () {
		...
		it( 'Sould look for jobs in "My open Jobs" and "Update Status" to "Arrived at Job"'.green, function () {
			...
			if ( lastUser.userRole != 'client' 
				...
				.then( function ( openJobs ) {
					...
					if ( openJobs ) {
						...
						.click()
						.sleep ( 800 )
						.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.arrivedJob ) )
						.then( function ( arrivedJob ) {

							if ( arrivedJob ) {
								console.log( ' Updated Statuse to "Arrived at Job".'.red );
								return arrivedJob
								.click();

							} else {
								return driver
								.elementByXPathIfExists( commons.textToXPath( elements.jobsScreen.updateStatusOptions.arrivedJobPlus ) )
								.then( function ( arrivedJobPlus ) {

									if ( arrivedJobPlus ) {
										console.log( 'Updated Status to "Arrived at Job +"'.red );
										return arrivedJobPlus
										.click()
										.sleep ( 1000 )
										.then( function () {
										...
										.then( function ( updateFormInfo ) {
											...
											if ( updateFormInfo ) {
												...
												console.log( 'Current Job does not need to updated to "Arrived at Job" Status'.red );
												return driver
		...
		it( 'should set currentTest to "passed"'.green, function ( done ) {
			...
			console.log( 'arrived at Job test has Passed....'.green );
			done();
		} );
	} );
};